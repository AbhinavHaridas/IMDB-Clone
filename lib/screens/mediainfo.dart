         ...
         Container(
             ...
             child: Row(
               children: [
                 ...
                 Container(
                     margin: const EdgeInsets.only(left: 10),
                     child: const Text("Add to Watchlist", style: TextStyle(color: Colors.white, fontSize: 18),)
                 )
               ],
             )
         ),
               ...
               children: [
                 Column(
                     children: [
                       ...
                       Row(
                         children: [
                           Text("${(data['imdbRating'] == null)? 0: data['imdbRating']}", style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
                           const Text("/10", style:TextStyle(fontSize: 23, color: Colors.white ))
                         ],
                       ),
                       Text("${(int.parse(((data['imdbVotes'] == null)? 0: data['imdbVotes']).replaceAll(",", "")) / 1000000).toStringAsFixed(1)}M", style: TextStyle(color: Colors.white),)
                     ]
                 ),
                 Column(
                     children: [
                       const Icon(Icons.star, color: Colors.blue, size: 25,),
                       Row(
                         children: const [
                           Text("9", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
                           Text("/10", style:TextStyle(fontSize: 23 , color: Colors.white))
                         ],
                       ),
                 ...
                 Column(
                     children: [
                       Container(
                           ...
                           child: Text("${(data["Metascore"] == null)? 0: data["Metascore"]}", style: const TextStyle(fontSize: 25, color: Colors.white))
                       ),
                       const Text("Metascore", style: TextStyle(color: Colors.white, fontSize: 18)),
                       const Text("36 critics", style: TextStyle(color: Colors.white))
                     ]
                 ),
               ]
           ),
